...
class AppRouter {
  static final router = GoRouter(
    ...
    routes: [
      ...
      // GoRoute(
      //   path: '/imagePreviewWardrobe',
      //   name: 'imagePreviewWardrobe',
      //   builder:
      //       (context, state) => MainShell(
      ...
      //   name: 'result1',
      //   builder: (context, state) {
      //     final result = state.extra as StyleAnalyzeClass;
      //     return MainShell(
      //       child: ResultPage(result: result),
      //       appBarTitleGrey: 'Your Final Cut Breakdown',
      //       showBackButton: true,
      //       showBottomNavBar: false,
      //       showAppBar: true,
      //       loc: 'scan&discover',
      ...
      //   name: 'result2',
      //   builder: (context, state) {
      //     final result = state.extra as AutoanalyzeClass?;
      //     Developer.log("Received result2: $result");
      //     if (result == null) return const ErrorPage();
      //     return MainShell(
      //       child: ResultPage2(result: result),
      //       appBarTitleGrey: 'COLOR ANALYSIS',
      //       showBackButton: true,
      //       showBottomNavBar: false,
      //       showAppBar: true,
      //       loc: 'result1',
      ...
      //   name: 'product',
      //   builder: (context, state) {
      //     final result1 = state.extra as List<ProductClass>?;
      //     if (result1 == null) return const ErrorPage();
      //     return MainShell(
      //       child: OldProductPage(result: result1),
      //       appBarTitleGrey: 'YOUR PERSONALIZED PICKS',
      //       showBackButton: true,
      //       showBottomNavBar: true,
      //       showAppBar: true,
      //       loc: 'result2',
      //       extraData: ResultCache.resultData,
      //     );
      //   },
      // ),
      ...
      GoRoute(
        ...
        builder: (context, state) {
          return MainShell(
            ...
            appBarTitlePink: 'Customized items for you.\nCurated by us with ❤️',
            showBackButton: true,
            showBottomNavBar: false,
            showAppBar: true,
          );
      ...
      //Find your skin tone in 3 seconds!
      // GoRoute(
      //   path: '/skin_image_quiz',
      //   name: 'skin_image_quiz',
      //   builder: (context, state) {
      //     final bodyShape = state.uri.queryParameters["body_shape"];
      //     Developer.log("SkinImageQuizPage Body Shape: $bodyShape");
      //     if (bodyShape == null) {
      //       return const MainShell(
      //         child: Center(child: Text('Invalid body shape parameter')),
      ...
      //     }
      //     return MainShell(
      //       child: SkinImageQuizPage(body_shape: bodyShape),
      //       appBarTitleGrey: 'Choose the Body type that ',
      //       appBarTitlePink: 'resembles yours!',
      //       showAppBar: true,
      //       showBackButton: true,
      //       showBottomNavBar: false,
      //       loc: 'body_shape_option',
      ...
      //   builder: (context, state) {
      //     final bodyShape =
      //         state.uri.queryParameters["body_shape"] ??
      //         ResultCache.selectedBodyShape;
      //     Developer.log("SkinImageQuizPage Body Shape: $bodyShape");
      ...
      //     }
      //     return MainShell(
      //       child: Quiz1Page(body_shape: bodyShape),
      //       appBarTitleGrey: 'Discover your skin tone in',
      //       appBarTitlePink: ' 3 seconds!',
      //       showAppBar: true,
      //       showBackButton: true,
      //       showBottomNavBar: false,
      //       loc: 'body_shape_option',
      ...
      GoRoute(
        ...
        builder: (context, state) {
          final bodyShape = state.uri.queryParameters["body_shape"];
          // final quiz_1 =
          //     state.uri.queryParameters["quiz1"] ?? ResultCache.selectedQuiz1;
          Developer.log("SkinImageQuizPage Body Shape: $bodyShape");
          // Developer.log("Skin Tone select by User: $quiz_1");
          if (bodyShape == null) {
            return const MainShell(
              child: ErrorPage(
                errorTxt:
      ...
      GoRoute(
        path: '/faceImageUpload',
        name: 'faceImageUpload',
        builder: (context, state) {
          final bodyShape = state.uri.queryParameters["body_shape"];
          Developer.log("FaceImageUploadPage Body Shape: $bodyShape");
          if (bodyShape == null) {
            return const MainShell(
              child: Center(child: Text('Invalid body shape parameter')),
              appBarTitleGrey: 'Error',
          ...
          return MainShell(
            child: FaceImageUploadPage(body_shape: bodyShape),
            appBarTitleGrey: 'Upload Your Face Image',
            showAppBar: true,
            showBackButton: true,
            showBottomNavBar: false,
            loc: 'skin_image_quiz',
      ...
      //chat popup screen -- overlay with product page
      // GoRoute(
      //   path: "/chatPopupOverlay",
      //   name: "chatPopupOverlay",
      //   builder: (context, state) {
      //     return ChatOverlayManager(
      //       userName: "Surabhi",
      //       child: AffiliateLinksPage(),
